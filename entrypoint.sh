...
UUID=${UUID:-'dae4cbf1-f1c0-41f7-80cd-4e68265dff79'}
VMESS_WSPATH=${VMESS_WSPATH:-'dae4cbf1-f1c0-41f7-80cd-4e68265dff79/vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'dae4cbf1-f1c0-41f7-80cd-4e68265dff79/vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'dae4cbf1-f1c0-41f7-80cd-4e68265dff79/trojan'}
SS_WSPATH=${SS_WSPATH:-'dae4cbf1-f1c0-41f7-80cd-4e68265dff79/shadowsocks'}
